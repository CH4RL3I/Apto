...
-- 1. Demo auth.users (one per case study).
insert into auth.users (id, email, instance_id, aud, role, email_confirmed_at, created_at, updated_at, raw_app_meta_data, raw_user_meta_data) values
  ('a357b956-44aa-5307-8e51-d24e9ec26a48', 'demo+cs-01-pm-feature-cut@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('08ed8986-81ca-58e1-8080-9fa41abbc1d3', 'demo+cs-02-pm-onboarding-redesign@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('320ecfe6-6c48-5a6d-8bd4-0e0c4e4199f5', 'demo+cs-03-pm-pmf-validation@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('28db8855-6ca2-5c72-86a6-299bc8d0b8f8', 'demo+cs-04-data-margin-deepdive@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('4a217712-6ef5-5299-86a4-f3714ff3ee52', 'demo+cs-05-data-churn-features@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('0a0d69b4-46b2-5ec2-868c-1ae53bdab98c', 'demo+cs-06-sports-stadium-u30@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('8a1ab7ed-8a6c-5f68-87b7-a4f7b8704626', 'demo+cs-07-sports-sprint-drop@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('1d535270-ad48-527d-807f-de08083ac7cf', 'demo+cs-08-ux-senior-banking@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('69f056be-ab4b-5920-8f32-7565ff173c62', 'demo+cs-09-sales-stalled-deal@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('7c49763b-7276-57c9-8d90-870c2181d056', 'demo+cs-10-podcast-scale@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('40310e85-0b1c-5a41-8110-a8fe1cc04a35', 'demo+cs-11-hotel-review-score@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('e63e4162-1d59-501e-8ef6-8c2aec18db37', 'demo+cs-12-consulting-cost-reduction@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('78aec07a-f5a7-5d16-82ca-b804d75d7fd7', 'demo+cs-13-swe-build-vs-buy@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('38489fbd-ec43-5dea-84c3-ee671c7624bd', 'demo+cs-14-ml-production-tradeoff@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('7c130432-43d9-5f6a-864c-afca00c9f35b', 'demo+cs-15-ib-valuation-ma@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('733a96e4-afb4-5f39-8fc2-ee9a7feef9f7', 'demo+cs-16-fpa-forecast-revision@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('8dda4b7c-b614-511d-8179-ff0a9c34f452', 'demo+cs-17-clinical-enrollment@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('bb3b40d7-5f52-52d8-85c3-70ea68298829', 'demo+cs-18-medical-reimbursement@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('d3601fe4-0483-5d15-8558-828f9b13f249', 'demo+cs-19-creative-director-ev-launch@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('e3b3dcb7-247a-5ea9-86f7-4866f3b1ec9b', 'demo+cs-20-copywriter-rebrand@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('2536e577-2de3-54d6-8425-1a7d4dc616c9', 'demo+cs-21-sustainability-scope3@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('eec56e47-3f52-55c1-8293-07a26f590dca', 'demo+cs-22-compliance-gdpr-incident@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('fa75d2ed-d2d6-56e0-8482-94ce3053bc28', 'demo+cs-23-policy-ai-act@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('6fe2436d-6ab0-563a-80e4-41897ef9ea4f', 'demo+cs-24-edtech-engagement-drop@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('88b285a6-cfac-5dc3-870a-a5d178212a70', 'demo+cs-25-manufacturing-line-efficiency@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('f2ea3566-b8b8-5b41-8c7c-aac9e5ce0d60', 'demo+cs-26-architect-brownfield@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('39ce8511-0e28-5aa2-8f61-d7a5d6408152', 'demo+cs-27-ld-leadership-program@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('cdbf29bb-0e3b-562a-877d-cd934c3eac4e', 'demo+cs-28-hrbp-performance-conversation@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('0ad72562-7e46-5df8-8981-8857fcd4a7cf', 'demo+cs-29-growth-cac-rising@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('8ba8f3b0-fa16-508a-84f6-e087d50af82b', 'demo+cs-30-lifecycle-reactivation@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('249a1679-3f7b-554f-82c4-32d8eaa2846d', 'demo+cs-31-journalism-whistleblower@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('4c965671-a027-5006-860e-56f05e05411c', 'demo+cs-32-renewables-ppa-deal@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('67c16c1a-1c49-5781-873f-38840d506aae', 'demo+cs-33-demand-planner-stockout@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('35cf6299-fdd3-58d8-8cf7-df2e15ce6d92', 'demo+cs-34-aerospace-anomaly@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('137c8991-4edb-57ea-8c06-fd3838175d87', 'demo+cs-35-wealth-portfolio-review@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb),
  ('d2117dfe-d60c-521e-87df-02cc59a09fb9', 'demo+cs-36-corporate-law-ma-dd@apto.test', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb)
on conflict (id) do nothing;

-- 2. public.users mirroring those auth users with role='company'.
...
-- 3. public.companies, one per case study.
...
-- 4. public.case_studies linked to the demo companies.
